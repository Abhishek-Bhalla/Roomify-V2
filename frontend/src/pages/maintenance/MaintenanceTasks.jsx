...
import { Search, Filter, RefreshCw, Wrench, Eye } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">All maintenance tasks assigned to you</p>
        </div>
        <div className="flex gap-2 sm:gap-3">
          ...
          <Button variant="outline" onClick={fetchTasks} className="flex-1 sm:flex-none">
